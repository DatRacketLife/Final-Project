  ...
  (cond [(empty? lol) empty]
        [
         ...
         (cond
           ...
           [(string-ci=? (first lol) "ab") (cons  56 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "b") (cons  59 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "bb") (cons  58 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "c") (cons  48 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "cb") (cons  47 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "d") (cons  50 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "db") (cons  49 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "e") (cons  52 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "eb") (cons  51 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "f") (cons  53 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "fb") (cons  52 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "g") (cons  55 (list->tones (rest lol)))]
           [(string-ci=? (first lol) "gb") (cons  54 (list->tones (rest lol)))]
